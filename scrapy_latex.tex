...
\begin{frame}[fragile]
	\frametitle{\insertsection{}: \insertsubsection{}}
	\begin{itemize}
		\item erstellen Sie einen Scrapy-Spider, der alle Vorkommen von in Fefes Blog verlinkten Domains zählt: \begin{itemize}
			\item der Spider soll in der Ausgabedatei (beliebiges Format) eine Datenstruktur als Dictionary anlegen: \begin{lstlisting} 
{
  ...
  ...
		...
		\item nur die Links aus eigentlichen Inhalten (d.h. kein Impressum, FAQ o.Ä.) sollen mitgezählt werden
		\item die Einträge sollen absteigend sortiert sein
		\item die [l]-Links sollen nicht mitgezählt werden????
		\end{itemize}
	\end{itemize}
\end{frame}
